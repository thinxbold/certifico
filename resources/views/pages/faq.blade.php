@extends('layouts.landing', ['title' => 'O-Tech || Faq'])

@section('content')
  <!-- ================= FAQ section start ================= -->
  <section class="tx-hero-section bg-gradient-light">
    <div class="container">
      <h1 class="tx-section-heading text-center mb-8">Frequently Asked Questions</h1>
      ...
      <div class="row gy-5">
        <div class="col-lg-8 mx-auto text-center d-flex justify-content-center">
          <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
              <button class="nav-link" id="service-tab" data-bs-toggle="tab" data-bs-target="#service-tab-pane"
                type="button" role="tab" aria-controls="service-tab-pane" aria-selected="false">It Service</button>
            </li>
            <li class="nav-item" role="presentation">
              <button class="nav-link" id="technology-tab" data-bs-toggle="tab" data-bs-target="#technology-tab-pane"
                type="button" role="tab" aria-controls="technology-tab-pane"
            ...
            <li class="nav-item" role="presentation">
              <button class="nav-link" id="security-tab" data-bs-toggle="tab" data-bs-target="#security-tab-pane"
                type="button" role="tab" aria-controls="security-tab-pane" aria-selected="false">Cyber
                security</button>
            </li>
            <li class="nav-item" role="presentation">
              <button class="nav-link" id="support-tab" data-bs-toggle="tab" data-bs-target="#support-tab-pane"
                type="button" role="tab" aria-controls="support-tab-pane" aria-selected="false">Tech
                Support</button>
            </li>
          </ul>
        </div>
        ...
        <div class="col-lg-12">
          <div class="tab-content" id="myTabContent">
              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="accordion" id="accordion1">
                    <!-- single item -->
                    <div class="tx-accordion-item tx-accordion-item-2 mb-20">
                      ...
                      <div id="collapse1" class="accordion-collapse collapse show" aria-labelledby="heading1"
                        ...
                        <div class="accordion-body">
                          <p>We prioritize security by implementing multi-layered protection strategies, including
                            firewalls, encryption, threat monitoring.</p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="accordion" id="accordion2">
                    ...
                    <div class="tx-accordion-item tx-accordion-item-2 mb-20">
                      <h2 class="accordion-header" id="heading9">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                          data-bs-target="#collapse9" aria-expanded="false" aria-controls="collapse8">
            ...
            <!-- 4 -->
            <div class="tab-pane fade" id="security-tab-pane" role="tabpanel" aria-labelledby="technology-tab"
              tabindex="0">
              <div class="row">
                <div class="col-lg-6">
            ...
            <!-- 5 -->
            <div class="tab-pane fade" id="support-tab-pane" role="tabpanel" aria-labelledby="technology-tab"
              tabindex="0">
              <div class="row">
                <div class="col-lg-6">
                  <div class="accordion" id="accordion7">
                    ...
                    <div class="tx-accordion-item tx-accordion-item-2 mb-20">
                      <h2 class="accordion-header" id="heading51">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse"
                          data-bs-target="#collapse51" aria-expanded="true" aria-controls="collapse51">
                          What types of IT services do you offer?
                          <span><i class="fa-regular fa-angle-down"></i></span>
                        </button>
                      </h2>
                      <div id="collapse51" class="accordion-collapse collapse show" aria-labelledby="heading51"
