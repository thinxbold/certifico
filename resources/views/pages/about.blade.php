@extends('layouts.landing', ['title' => 'Certifico || About'])
    ...
    <div class="container">
      ...
      <div class="tx-section-bg-image mb-0 animated">
        ...
        <div class="caption">
          ...
          <a href="{{ route('second', ['pages', 'team']) }}" class="btn btn-secondary">Meet Our Team</a>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="row align-items-center justify-content-between gy-4 text-center text-xl-start">
        {{-- <div class="col-xl-auto">
          <h4 class="tx-brand-title">Our Partner</h4>
        </div> --}}
        ...
        {{-- <div class="col-xl-auto">
          <a href="{{ route('second', ['pages', 'contact']) }}" class="btn btn-secondary btn-icon-leading">Call Us <i
