...
<header>
  <div id="tx-header-sticky" class="tx-header-area tx-transparent-header tx-transparent-header-4">
    <div class="container tx-header-bg-3">
      <div class="row align-items-center">
                        ...
                        <div class="col mb-25">
                          <div class="tx-home-thumb fix p-relative z-index-1">
                            ...
                            <div class="tx-home-btn">
                              <a href="{{ route('any', 'index') }}" target="_blank" class="thme-btn3">Multi
                                Page<span><i class="fa-regular fa-arrow-right"></i></span></a>
                              <a href="{{ route('second', ['single', 'index-1']) }}" target="_blank"
                                class="thme-btn3 mt-20">Single Page<span><i
                          ...
                          <div class="tx-home-thumb fix p-relative z-index-1">
                            ...
                            <div class="tx-home-btn">
                              <a href="{{ route('second', ['demo', 'index2']) }}" target="_blank"
                                class="thme-btn3">Multi Page<span><i class="fa-regular fa-arrow-right"></i></span></a>
        ...
        <div class="col-lg-3 col-md-6 col-6">
          <div class="tx-hero-btn-3 d-none d-lg-block text-lg-end fl-right">
            <a href="" class="tx-btn-3">GET STARTED<span><i class="fa-regular fa-arrow-right"></i></span></a>
          </div>
...
<div class="tx-offcanvas tx-offcanvas-3">
  <div class="tx-offcanvas-wrapper">
    <div class="tx-offcanvas-header d-flex justify-content-between align-items-center mb-50">
      <div class="tx-offcanvas-logo">
        <a href="{{ route('any', 'index') }}"><img src="/img/logo/tx-logo-3.2.png" alt="" /></a>
      </div>
    ...
    <div class="tx-offcanvas-menu tx-offcanvas-menu-3 d-lg-none mb-40">
      <nav></nav>
    </div>

    <div class="tx-offcanvas-btnm text-center mb-30">
      <div class="tx-about-authbtn">
        <a href="#" class="thme-btn3 w-100">Get Started <span><i
              class="fa-regular fa-arrow-right"></i></span></a>
      </div>
    </div>
    ...
    <div class="tx-offcanvas-info mb-30">
      ...
      <div class="tx-offcanvas-info-box mb-15">
        <div class="tx-offcanvas-info-box-icon">
          <span><img src="/img/icons/tx-cta-ph-3.1.svg" alt="" /></span>
        </div>
      ...
      <div class="tx-offcanvas-info-box mb-15">
        <div class="tx-offcanvas-info-box-icon">
          <span><img src="/img/icons/tx-cta-mail-3.2.svg" alt="" /></span>
        </div>
        <div class="tx-offcanvas-info-box-text">
      ...
      <div class="tx-offcanvas-info-box mb-15">
        <div class="tx-offcanvas-info-box-icon">
          <span><img src="/img/icons/tx-cta-mail-3.3.svg" alt="" /></span>
        </div>
        <div class="tx-offcanvas-info-box-text">
