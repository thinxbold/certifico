      ...
      <div class="row align-items-center">
                      ...
                      <div class="row gx-4 row-cols-1 row-cols-lg-4">
                        <div class="col mb-25">
                          <div class="tx-home-thumb fix p-relative z-index-1">
                            ...
                            <div class="tx-home-btn tx-home-btn4">
                              <a href="{{ route('any', 'index') }}" target="_blank" class="tx-btn-sec">
                                <span class="tx-btn-wrap">
                                  <span class="tx-btn-y-1">Multi Page</span>
                                  <span class="tx-btn-y-2">Multi Page</span>
                                </span>
                              </a>

                              <a href="{{ route('second', ['single', 'index-1']) }}" target="_blank"
                                class="tx-btn-sec mt-20">
                                <span class="tx-btn-wrap">
                                  <span class="tx-btn-y-1">Single Page</span>
                                  <span class="tx-btn-y-2">Single Page</span>
                                </span>
                              </a>
                            </div>
                          </div>
                        ...
                        <div class="col mb-25">
                          <div class="tx-home-thumb fix p-relative z-index-1">
                            ...
                            <div class="tx-home-btn tx-home-btn4">
                              <a href="{{ route('second', ['demo', 'index2']) }}" target="_blank" class="tx-btn-sec">
                                <span class="tx-btn-wrap">
                                  <span class="tx-btn-y-1">Multi Page</span>
                                  <span class="tx-btn-y-2">Multi Page</span>
                                </span>
                        ...
                        <div class="col mb-25">
                          <div class="tx-home-thumb fix p-relative z-index-1">
                            ...
                            <div class="tx-home-btn tx-home-btn4">
                              <a href="{{ route('second', ['demo', 'index3']) }}" target="_blank" class="tx-btn-sec">
                                <span class="tx-btn-wrap">
                                  <span class="tx-btn-y-1">Multi Page</span>
                                  <span class="tx-btn-y-2">Multi Page</span>
                                </span>
                        ...
                        <div class="col mb-25">
                          <div class="tx-home-thumb fix p-relative z-index-1">
                            ...
                            <div class="tx-home-btn tx-home-btn4">
                              <a href="{{ route('second', ['demo', 'index4']) }}" target="_blank" class="tx-btn-sec">
                                <span class="tx-btn-wrap">
                                  <span class="tx-btn-y-1">Multi Page</span>
                                  <span class="tx-btn-y-2">Multi Page</span>
                                </span>
        ...
        <div class="col-lg-3 col-md-6 col-6">
          <div class="tx-hero-btn d-none d-lg-block text-lg-end">
            <a href="{{ route('second', ['pages', 'contact']) }}" class="tx-btn-sec">
              <span class="tx-btn-wrap">
