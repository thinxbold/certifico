    ...
    <div class="container tx-header-bg-4">
      <div class="row align-items-center">
        <div class="col-lg-2 col-md-6 col-6">
          <div class="tx-logo">
            <a href="{{ route('second', ['single', 'index-1']) }}"><img src="/img/logo/tx-logo-1.1.png"
                alt="" /></a>
          </div>
        </div>
        ...
        <div class="col-lg-2 col-md-6 col-6">
          <div class="tx-herobtn d-none d-lg-block fl-right">
  ...
  <div class="tx-offcanvas-wrapper">
    <div class="tx-offcanvas-header d-flex justify-content-between align-items-center mb-50">
      <div class="tx-offcanvas-logo">
        <a href="{{ route('any', 'index') }}"><img src="/img/logo/tx-footer-logo-4.2.png" alt="" /></a>
      </div>
    ...
    <div class="tx-offcanvas-btnm text-center mb-30">
      <div class="tx-herobtn tx-aboutbtn w-100 tx-upper">
