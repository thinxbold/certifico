@extends('layouts.landing', ['title' => 'O-Tech || Service Left'])

@section('content')
  <!-- ================= Banner section start ================= -->
  <section class="tx-hero-section bg-gradient-light pt-9 pb-100">
    <div class="container">
      <div class="row g-3 gx-xl-9 mt-7">
        <div class="col-md-6">
          <div class="vl-breadcrumb">
            <h4 class="tx-section-subtitle">Our Services</h4>
            <h1 class="vl-section-heading-2">Sertifikasi BNSP</h1>
            <div class="vl-breadcrumb-list mt-3">
              <span><a href="{{ route('any', 'index') }}">Home</a></span>
              <span class="dvir"><i class="fa-solid fa-angle-right"></i></span>
              <span class="active"><a href="{{ route('second', ['services', 'service']) }}">Our Service</a></span>
              <span class="dvir"><i class="fa-solid fa-angle-right"></i></span>
        ...
        <div class="col-md-6 pt-5">
          <div class="mb-3">It is a long established fact that a reader will be distracted by the readable content of a
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="vl-sidebar-widget">
            ...
            <!-- phone -->
            <div class="vl-sidebar-widget-search mb-30 vl-gray-bg-4 br-16">
              <h3 class="vl-text-cmn-blck vl-fs-20 vl-lineheight-28 pb-24 m-0">If You Need Any Help <br /> Contact With Us
              </h3>
            ...
            <div class="vl-service-details-content">
              <div class="vl-service-content-block-1 mb-30">
                ...
                <p class="vl-text-para vl-fs-18 vl-lineheight-26 pb-16 m-0">
                  Keep your business running smoothly with reliable and optimized IT infrastructure. We <br /> provide
                  end-to-end infrastructure management network design & setup to maintenance <br /> and monitoring. Our
                  solutions ensure high availability, minimal downtime.
                </p>

                <p class="vl-text-para vl-fs-18 vl-lineheight-26 m-0">
                  Our managed IT services offer businesses the convenience of outsourcing technology <br />needs while
                  maintaining full control and visibility. From 24/7 system monitoring.
                </p>
              </div>
              ...
              <div class="vl-service-content-block-2 mb-30">
                <h3 class="vl-fs-32 vl-lineheight-32 vl-text-cmn-blck pb-16 m-0">Comprehensive IT Solutions for Every
                  Need</h3>
                <p class="vl-text-para vl-fs-18 vl-lineheight-26 pb-16 m-0">
                  Our range of IT services is designed to meet the diverse needs of businesses, whether <br /> small
                  startups or large enterprises. From managed IT support and cloud computing to <br /> cybersecurity &
                  software development, we offer end-to-end solutions that enhance.
                </p>

                <p class="vl-text-para vl-fs-18 vl-lineheight-26 m-0">
                  We offer end-to-end solutions that enhance efficiency and drive innovation. Our experts <br />
                  collaborate with you to identify pain points implement tailored strategies that optimize.
                </p>
              </div>
                ...
                <div class="col-lg-6 col-md-6">
                  <div class="vl-about-icon-box-4 vl-service-box vl-gray-bg-4 d-flex br-8 mb-30">
                    ...
                    <div class="vl-service-box-content">
                      <h3 class="vl-fs-18 vl-lineheight-18 pb-16 m-0"><a href="#">Testing & Quality Assurance</a>
                      </h3>
              ...
              <div class="vl-service-content-block-3">
                <h3 class="vl-fs-32 vl-lineheight-32 vl-text-cmn-blck pb-16 m-0">Innovative Solutions for a Competitive
                  Edge</h3>
                <p class="vl-text-para vl-fs-18 vl-lineheight-26 pb-16 m-0">
                  We specialize in delivering customized IT solutions that drive business transformation. <br /> Whether
                  you’re looking to streamline operations with automation, enhance customer <br /> engagement through
                  digital platforms, or safeguard your data with advanced.
                </p>

                <p class="vl-text-para vl-fs-18 vl-lineheight-26 m-0">
                  Cybersecurity measures, our services are built to provide a competitive advantage. With <br /> a
                  commitment to excellence, we help you stay ahead in today’s fast-evolving digital.
                </p>
              </div>
            </div>
          </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6 mb-30">
          <div class="vl-service-icon-box-4 vl-service-icon-box-4-bg vl-gray-bg-4 p-relative z-index-1 fix br-8">
            ...
            <div class="vl-service-icon-box-4-content4">
              ...
              <p class="pb-24">
                Leverage the power cloud to enhance <br /> scalability, flexibility, and performance <br />Our cloud
                computing solutions secure.
              </p>
        ...
        <div class="col-lg-4 col-md-6 mb-30">
          <div class="vl-service-icon-box-4 vl-service-icon-box-4-bg vl-gray-bg-4 p-relative z-index-1 fix br-8">
            ...
            <div class="vl-service-icon-box-4-content4">
              <h3 class="vl-service-icon-box-4-title pt-32 pb-16"><a href="#">IT Infrastructure Management</a>
              </h3>
              <p class="pb-24">
                Optimize your business operations with <br /> reliable IT infrastructure management <br /> From network
                setup to hardware.
              </p>
              <a href="#" class="readmore">Learn More <span><i class="fa-regular fa-arrow-right"></i></span></a>
            </div>
        ...
        <div class="col-lg-4 col-md-6 mb-30">
          <div class="vl-service-icon-box-4 vl-service-icon-box-4-bg vl-gray-bg-4 p-relative z-index-1 fix br-8">
            ...
            <div class="vl-service-icon-box-4-content4">
              ...
              <p class="pb-24">
                In today’s digital world, protecting your <br /> data is more critical than ever. Our Best <br />
