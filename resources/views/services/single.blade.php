  ...
  <section class="tx-section tx-hero-single pb-0">
    <div class="container p-relative h-100">
      <div class="tx-hero-single-img ratio ratio-1x1 ratio-lg-16x9 ratio-xl-21x9">
        ...
        <img src="/img/service/template-services.avif" alt="" class="img-cover z-n1">
      </div>
      ...
      <div class="row justify-content-center tx-hero-single-caption">
        <div class="col-11 d-flex flex-column" data-bs-theme="dark">
          <img src="/img/brand/cra-logo-badge.avif" alt="" class="logo-badge">
          <div class="tx-breadcrumb">
            ...
            <h1>CRA<sup>&reg;</sup><br><span>Certified Risk Associate</span></h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row justify-content-between text-center mb-5">
        ...
        <div class="col-lg-auto">
          ...
          <div class="small">Presentasi Materi • Diskusi dan Q&A • Audio-Visual</div>
        </div>
        <div class="col-lg-auto">
        ...
        <div class="col-lg-auto">
          ...
          <div class="small">2 Hari / 10 Sesi</div>
        </div>
        <div class="col-lg-auto">
          <h4 class="tx-section-subtitle">Simulasi Ujian & Ujian Online</h4>
          <div class="small">GAFM<sup>&reg;</sup></div>
        </div>
      </div>
      <hr>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-xl-11 col-xxl-9 mx-auto">
          <blockquote class="blockquote d-md-flex gap-5 mb-5" data-aos="fade-up">
          ...
          <div class="tx-service-content pb-5" data-aos="fade-up">
          ...
          <div class="tx-service-content list-col-2 list-xxl-col-3" data-aos="fade-up">
          ...
          <div class="tx-service-content list-check bg-primary-subtle rounded p-5 my-5" data-aos="fade-up">
          ...
          <div class="tx-service-content text-center">
            ...
            <div class="row tx-scroll-md-x g-3">
              <div class="col-9 col-md-5 col-lg-3" data-aos="fade-up">
          ...
          <div class="tx-service-content">
            <h2 class="text-center" data-aos="fade-up">Keputusan Hasil Asesmen dan Penerimaan Sertifikat</h2>
            <div class="row g-3">
              <div class="col-md-6" data-aos="fade-up">
