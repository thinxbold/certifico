  ...
  <section class="tx-section tx-hero-single pb-0">
    <div class="container p-relative h-100">
      <div class="tx-hero-single-img ratio ratio-1x1 ratio-md-16x9 ratio-xl-21x9">
        <img src="/img/service/ceip.avif" alt="" class="img-cover z-n1">
      </div>
      ...
      <div class="row justify-content-center tx-hero-single-caption">
        <div class="col-11 d-flex flex-column" data-bs-theme="dark">
          ...
          <div class="tx-breadcrumb">
            ...
            <h1>CEIP<sup>&reg;</sup><span>Certified ESG Investing Professional</span></h1>
          </div>
        </div>
      </div>
    </div>
              ...
              <div class="col-10">
                <div class="btn-list-group">
                  <a href="<?php echo e(route('third', ['services', 'sertifikasi-internasional', 'ceip-certified-esg-investing-professional'])); ?>"
                    class="btn btn-icon-leading arrow-right d-none">CEIP<sup>&reg;</sup> Certified ESG Investing
                    Professional</a>
...
<?php echo $__env->make('layouts.landing', ['title' => 'Certifico || Certified Risk Associate'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\certifico\resources\views/services/sertifikasi-internasional/ceip-certified-esg-investing-professional.blade.php ENDPATH**/ ?>