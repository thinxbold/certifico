<?php $__env->startSection('content'); ?>
  ...
  <section class="tx-section tx-hero-single pb-0">
    <div class="container p-relative h-100">
      <div class="tx-hero-single-img ratio ratio-1x1 ratio-md-16x9 ratio-xl-21x9">
        <img src="/img/service/cbcmp.avif" alt="" class="img-cover z-n1">
      </div>
      ...
      <div class="row justify-content-center tx-hero-single-caption">
        <div class="col-11 d-flex flex-column" data-bs-theme="dark">
          <div class="tx-logo-brand">
            <img src="/img/brand/logo-GAFM.svg" alt="">
            <img src="/img/brand/logo-GAFM.svg" alt="">
            <img src="/img/brand/logo-AAPM-lapel-pin.webp" alt="">
          </div>
          <div class="tx-breadcrumb">
            <h4 class="tx-section-subtitle">Sertifikasi Internasional <i
                class="fa-solid fa-badge-check text-secondary"></i>
            </h4>
            <h1>CBCMP<sup>&reg;</sup><span>Certified Business Continuity Management Professional</span></h1>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="tx-service-content text-center">
    <div class="container">
      <a href="<?php echo e(route('second', ['services', 'all'])); ?>" class="btn btn-dark btn-icon-leading"><i
              ...
              <div class="col-10">
                <div class="btn-list-group">
                  <a href="<?php echo e(route('third', ['services', 'sertifikasi-internasional', 'ceip-certified-esg-investing-professional'])); ?>"
                    class="btn btn-icon-leading arrow-right">CEIP<sup>&reg;</sup> Certified ESG Investing
                    Professional</a>
                  <a href="<?php echo e(route('third', ['services', 'sertifikasi-internasional', 'cgrcs-certified-governance-risk-compliance-specialist'])); ?>"
                    class="btn btn-icon-leading arrow-right">CGRCS<sup>&reg;</sup> Certified Governance Risk Compliance
                    Specialist</a>
                  <a href="<?php echo e(route('third', ['services', 'sertifikasi-internasional', 'cbcmp-certified-business-continuity-management-professional'])); ?>"
                    class="btn btn-icon-leading arrow-right d-none">CBCMP<sup>&reg;</sup> Certified Business Continuity
                    Management
                    Professional</a>
                  <a href="<?php echo e(route('third', ['services', 'sertifikasi-internasional', 'crme-certified-risk-modeling-expert'])); ?>"
                    class="btn btn-icon-leading arrow-right">CRME<sup>&reg;</sup> Certified Risk Modeling Expert</a>
                </div>
              </div>
            </div>
          </div>
...
<?php echo $__env->make('layouts.landing', ['title' => 'Certifico || Certified Risk Associate'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\certifico\resources\views/services/sertifikasi-internasional/cbcmp-certified-business-continuity-management-professional.blade.php ENDPATH**/ ?>