        ...
        <div class="col-md-6 col-lg-4 animated">
          <div class="tx-single-blog-item">
            <div class="card rounded-0">
              <a href="<?php echo e(route('second', ['articles', 'single'])); ?>" class="stretched-link">
...
<?php echo $__env->make('layouts.landing', ['title' => 'Certifico || Our Story'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\certifico\resources\views/articles/our-story.blade.php ENDPATH**/ ?>