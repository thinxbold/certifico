<?php $__env->startSection('content'); ?>
  ...
  <section class="tx-section-border">
    <div class="container">
      <?php echo $__env->make('icons.border-left', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
  </section>
  <!-- ================= Section border end ================= -->
...
<?php echo $__env->make('layouts.landing', ['title' => 'Certifico || Team'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\certifico\resources\views/pages/team.blade.php ENDPATH**/ ?>