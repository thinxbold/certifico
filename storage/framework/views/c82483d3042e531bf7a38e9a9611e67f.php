<?php $__env->startSection('content'); ?>
  ...
  <?php echo $__env->make('layouts.partials.section-border-left', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
      ...
      <div class="row justify-content-between gy-3">
        <div class="col-lg-7">
          <div class="tx-breadcrumb-list">
            ...
            <span><a href="<?php echo e(route('second', ['course', 'courses'])); ?>">Courses</a></span>
            <span><a href="<?php echo e(route('second', ['course', 'introduction'])); ?>">CRP - Certified Risk
                Professional</a></span>
          ...
          <div class="tx-sidebar-widget rounded border px-3 py-4 px-xxl-4">
            ...
            <div class="tx-sidebar-widget">
              <div class="tx-sidebar-rec-post">
                <ul>
                  <li>
                    <a href="<?php echo e(route('second', ['course', 'single'])); ?>" class="active">Mengelola Risiko Usaha<span><i
                          class="fa-regular fa-angle-right"></i></span></a>
                  </li>
                  <li>
                    <a href="<?php echo e(route('second', ['course', 'single'])); ?>">Menentukan Risk Owner dan Fungsi Terkait untuk
                      Setiap Kejadian Risiko<span><i class="fa-regular fa-angle-right"></i></span></a>
                  </li>
                  <li>
                    <a href="<?php echo e(route('second', ['course', 'single'])); ?>">Mendokumentasikan Risiko kedalam Risk
                      Register<span><i class="fa-regular fa-angle-right"></i></span></a>
                  </li>
                  <li>
                    <a href="<?php echo e(route('second', ['course', 'single'])); ?>">Mendefinisikan Kriteria Risiko<span><i
                          class="fa-regular fa-angle-right"></i></span></a>
                  </li>
                  <li>
                    <a href="<?php echo e(route('second', ['course', 'single'])); ?>">Melakukan Penentuan Skala Prioritas Terhadap
    ...
    <div class="container">
      <div class="tx-service-details row g-5">
        ...
        <div class="col d-flex flex-wrap gap-2">
          <a href="<?php echo e(route('second', ['course', 'courses'])); ?>" class="btn btn-dark btn-icon-leading arrow-left">Back
            to Dashboard</a>
...
<?php echo $__env->make('layouts.landing', ['title' => 'Certifico || CRP - Certified Risk Professional'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\certifico\resources\views/course/single.blade.php ENDPATH**/ ?>