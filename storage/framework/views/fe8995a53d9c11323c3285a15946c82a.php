  ...
  <section class="tx-section tx-hero-single pb-0">
    <div class="container p-relative h-100">
      <div class="tx-hero-single-img ratio ratio-1x1 ratio-md-16x9 ratio-xl-21x9">
        ...
        <img src="/img/service/crp.avif" alt="" class="img-cover z-n1">
      </div>
      ...
      <div class="row justify-content-center tx-hero-single-caption">
        <div class="col-11 d-flex flex-column" data-bs-theme="dark">
          ...
          <div class="tx-breadcrumb">
            <h4 class="tx-section-subtitle">Sertifikasi BNSP <i class="fa-solid fa-badge-check text-secondary ms-2"></i>
            </h4>
            <h1>CRP<sup>&reg;</sup><span>Certified Risk Proffesional</span></h1>
          </div>
        </div>
      </div>
    </div>
              ...
              <div class="col-10">
                <div class="btn-list-group">
                  <a href="<?php echo e(route('third', ['services', 'sertifikasi-bnsp', 'cra-certified-risk-associate'])); ?>"
                    class="btn btn-icon-leading arrow-right">CRA<sup>&reg;</sup> Certified Risk Associates</a>
                  <a href="<?php echo e(route('third', ['services', 'sertifikasi-bnsp', 'crp-certified-risk-professional'])); ?>"
                    class="btn btn-icon-leading arrow-right d-none">CRP<sup>&reg;</sup> Certified Risk Professional</a>
                </div>
              </div>
            </div>
          </div>
...
<?php echo $__env->make('layouts.landing', ['title' => 'Certifico || Certified Risk Associate'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\certifico\resources\views/services/sertifikasi-bnsp/crp-certified-risk-professional.blade.php ENDPATH**/ ?>