    ...
    <div class="container tx-header px-lg-3">
      <div class="row align-items-center justify-content-lg-between">
        <div class="col-lg-auto col-md-6 col-6">
          <div class="tx-logo">
            <a href="<?php echo e(route('any', 'index')); ?>"><img src="/img/logo/logo.svg" alt="" /></a>
          </div>
        </div>
            ...
            <nav class="tx-mobile-menu-active">
              <ul>
                <li class="nav_link_parent">
                  <a href="<?php echo e(route('any', 'index')); ?>"><span>Home</span></a>
                </li>
                ...
                <li class="has-dropdown megamenu nav_link_parent">
                  ...
                  <ul class="sub-menu first row justify-content-xl-between gx-0 gx-xl-3 gx-xxl-4">
                    ...
                    <li class="col-xl-auto block-menu">
                      <a href="<?php echo e(route('second', ['services', 'sertifikasi-bnsp'])); ?>" class="nav-link-heading">
                        Sertifikasi BNSP
                      </a>
                      <ul class="sub-menu child-menu">
                        <li>
                          <a class="nav_link_child"
                            href="<?php echo e(route('third', ['services', 'sertifikasi-bnsp', 'cra-certified-risk-associate'])); ?>">
                            CRA<sup>&reg;</sup> Certified Risk Associate
                          </a>
                        </li>
                        <li>
                          <a class="nav_link_child"
                            href="<?php echo e(route('third', ['services', 'sertifikasi-bnsp', 'crp-certified-risk-professional'])); ?>">
                    ...
                    <li class="col-xl-auto block-menu">
                      ...
                      <ul class="sub-menu child-menu">
                        <li>
                          <a class="nav_link_child"
                            href="<?php echo e(route('third', ['services', 'sertifikasi-internasional', 'ceip-certified-esg-investing-professional'])); ?>">CEIP<sup>&reg;</sup>
                            Certified ESG Investing Professional</a>
                        </li>
                        <li>
                          <a class="nav_link_child"
                            href="<?php echo e(route('third', ['services', 'sertifikasi-internasional', 'cgrcs-certified-governance-risk-compliance-specialist'])); ?>">
                            CGRCS<sup>&reg;</sup> Certified Governance Risk Compliance Specialist
                          </a>
                        </li>
                        <li>
                          <a class="nav_link_child"
                            href="<?php echo e(route('third', ['services', 'sertifikasi-internasional', 'cbcmp-certified-business-continuity-management-professional'])); ?>">
                            CBCMP<sup>&reg;</sup> Certified Business Continuity Management Professional
                          </a>
                        </li>
                        <li>
                          <a class="nav_link_child"
                            href="<?php echo e(route('third', ['services', 'sertifikasi-internasional', 'crme-certified-risk-modeling-expert'])); ?>">
                    ...
                    <li class="col-xl-auto block-menu">
                      <a href="<?php echo e(route('second', ['services', 'sertifikasi-iso'])); ?>" class="nav-link-heading">
                        Sertifikasi ISO
                      </a>
                      <ul class="sub-menu child-menu">
                        <li>
                          <a class="nav_link_child"
                            href="<?php echo e(route('third', ['services', 'sertifikasi-iso', 'iso-22301-2019'])); ?>">
                            ISO 22301:2019
                          </a>
                        </li>
                        <li>
                          <a class="nav_link_child"
                            href="<?php echo e(route('third', ['services', 'sertifikasi-iso', 'iso-9001-2015'])); ?>">
                            ISO 9001:2015
                          </a>
                        </li>
                        <li>
                          <a class="nav_link_child"
                            href="<?php echo e(route('third', ['services', 'sertifikasi-iso', 'iso-31000-2018'])); ?>">
                            ISO 31000:2018
                          </a>
                        </li>
                      </ul>
                    ...
                    <li class="col-xl-auto block-menu">
                      <a href="<?php echo e(route('second', ['services', 'corporate-training'])); ?>"
                    ...
                    <div class="col-xl-auto block-cta d-none d-xl-block">
                      ...
                      <a href="<?php echo e(route('second', ['services', 'all'])); ?>" class="btn btn-dark mt-n5 me-2 "><i
                ...
                <li class="nav_link_parent">
                  <a href="<?php echo e(route('second', ['course', 'courses'])); ?>"><span>Courses</span></a>
                </li>

                <li>
                  <a href="<?php echo e(route('second', ['articles', 'our-story'])); ?>"><span>Article</span></a>
                </li>
                ...
                <li class="has-dropdown nav_link_parent">
                  ...
                  <ul class="sub-menu">
                    <li>
                      <a href="<?php echo e(route('second', ['pages', 'about'])); ?>">Company Overview</a>
                    </li>
                    <li>
                      <a href="<?php echo e(route('second', ['pages', 'team'])); ?>">Team</a>
                    <li>
                      <a href="#">Competencies</a>
                    </li>
                </li>
                <li>
                  <a href="<?php echo e(route('second', ['pages', 'faq'])); ?>">Faq</a>
                </li>
              </ul>
              </li>

              <li class="nav_link_parent">
                <a href="<?php echo e(route('second', ['pages', 'contact'])); ?>"><span>Contact</span></a>
              </li>
              </ul>
            </nav>
          </div>
        ...
        <div class="col-lg-auto col-md-6 col-6">
          <a href="<?php echo e(route('second', ['pages', 'contact'])); ?>"
...
<div class="tx-offcanvas tx-offcanvas-bg-1">
  <div class="tx-offcanvas-wrapper">
    ...
    <div class="tx-offcanvas-btnm mb-30">
      <a href="<?php echo e(route('second', ['pages', 'contact'])); ?>" class="btn btn-cta btn-icon-leading ps-0">
        <span><i class="fa-regular fa-lock"></i></span>Sign Up
      </a>
      <a href="<?php echo e(route('second', ['pages', 'contact'])); ?>"
...
<!-- offcanvas menu end -->
<!-- ================= Header section End ================= -->
<?php /**PATH E:\certifico\resources\views/layouts/partials/header/navbar.blade.php ENDPATH**/ ?>