<?php $__env->startSection('content'); ?>
        ...
        <div class="row tx-hero-caption-absolute">
          <div class="col-xl-6 pt-xxl-5 pb-5 pb-xxl-0 p-relative">
            <div class="tx-section-title-wrapper mb-4 mb-xl-0 pt-0 pt-xl-5">
              ...
              <a href="<?php echo e(route('second', ['pages', 'contact'])); ?>" class="tx-hero-icon-animate">
                <?php echo $__env->make('icons.join-us', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
              </a>
            </div>
          </div>
        </div>
        ...
        <div class="col-8 col-lg-4 col-xl-3 tx-gallery-hero-services">
          <div class="tx-gallery-item animated">
            <div class="tx-gallery-item-img ratio ratio-1x1">
              ...
              <a href="<?php echo e(route('second', ['services', 'sertifikasi-bnsp'])); ?>" class="stretched-link">
        ...
        <div class="col-8 col-lg-4 col-xl-3 tx-gallery-hero-services">
          <div class="tx-gallery-item animated">
            <div class="tx-gallery-item-img ratio ratio-1x1">
              ...
              <a href="<?php echo e(route('second', ['services', 'sertifikasi-internasional'])); ?>" class="stretched-link">
                <div class="tx-gallery-item-con">
        ...
        <div class="col-8 col-lg-4 col-xl-3 tx-gallery-hero-services">
          <div class="tx-gallery-item animated">
            <div class="tx-gallery-item-img ratio ratio-1x1">
              ...
              <a href="<?php echo e(route('second', ['services', 'sertifikasi-iso'])); ?>" class="stretched-link">
                <div class="tx-gallery-item-con">
        ...
        <div class="col-8 col-lg-4 col-xl-3 tx-gallery-hero-services">
          <div class="tx-gallery-item animated">
            <div class="tx-gallery-item-img ratio ratio-1x1">
              ...
              <a href="<?php echo e(route('second', ['services', 'corporate-training'])); ?>" class="stretched-link">
                <div class="tx-gallery-item-con">
        ...
        <div class="col-8 col-lg-4 col-xl-3 tx-gallery-hero-services">
          <div class="tx-gallery-item animated">
            <div class="tx-gallery-item-img ratio ratio-1x1">
              ...
              <a href="<?php echo e(route('second', ['services', 'corporate-certification'])); ?>" class="stretched-link">
                <div class="tx-gallery-item-con">
  ...
  <section class="tx-section-border">
    <div class="container">
      <?php echo $__env->make('icons.border-center', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
  </section>
  ...
  <section class="tx-gallery tx-section p-relative z-index-1">
    <div class="container">
      <div class="tx-section-title-wrapper animated">
        ...
        <a href="<?php echo e(route('second', ['services', 'all'])); ?>" class="btn btn-dark btn-icon-leading arrow-right">View All
          Programs</a>
      </div>
        ...
        <div class="card border-0">
          <div class="tx-single-services-item">
            ...
            <div class="tx-single-services-content">
              ...
              <a href="<?php echo e(route('second', ['services', 'single'])); ?>"
                class="btn btn-secondary btn-icon-leading btn-sm">Learn More</a>
              <a href="<?php echo e(route('second', ['services', 'single'])); ?>" class="btn btn-tertiary btn-icon-leading btn-sm">
        ...
        <div class="card border-0">
          <div class="tx-single-services-item">
            <div class="tx-single-services-img ratio ratio-4x3">
              ...
              <a href="<?php echo e(route('third', ['services', 'sertifikasi-internasional', 'ceip-certified-esg-investing-professional'])); ?>"
                class="tx-single-services-title stretched-link">
                <div class="tx-single-services-meta-box">
        ...
        <div class="card border-0">
          <div class="tx-single-services-item">
            <div class="tx-single-services-img ratio ratio-4x3">
              ...
              <a href="<?php echo e(route('third', ['services', 'sertifikasi-iso', 'iso-22301-2019'])); ?>"
                class="tx-single-services-title stretched-link">
                <div class="tx-single-services-meta-box">
                  <img src="/img/brand/iso22301-logo-badge.avif" alt="">
                </div>
        ...
        <div class="card border-0">
          <div class="tx-single-services-item">
            <div class="tx-single-services-img ratio ratio-4x3">
              ...
              <a href="<?php echo e(route('third', ['services', 'sertifikasi-iso', 'iso-31000-2018'])); ?>"
                class="tx-single-services-title stretched-link">
                <div class="tx-single-services-meta-box">
                  <img src="/img/brand/iso31000-logo-badge.avif" alt="">
                </div>
  ...
  <section class="tx-section-border">
    <div class="container">
      <?php echo $__env->make('icons.border-right', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
  </section>
    ...
    <div class="container">
      <div class="row g-3 justify-content-between tx-section-title-wrapper mb-60">
        ...
        <div class="col-md-6 col-xl-6 pt-2 pt-md-4 animated">
          ...
          <a href="<?php echo e(route('second', ['pages', 'about'])); ?>" class="btn btn-more">
            ...
            <div class="card tx-testimonial-box">
              <div class="card-body">
                <div class="text-primary fa-stack fs-5 mb-5">
                  <?php echo $__env->make('icons.quote-left', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
                ...
                <div class="tx-testimonial-box-auth p-relative">
                  ...
                  <div class="tx-testimonial-box-auth-content">
                    <h4 class="tx-testimonial-box-auth-title">
                      <a href="<?php echo e(route('second', ['pages', 'team'])); ?>">Jang Wonyoung</a>
                    </h4>
                    <span>Korea</span>
                  </div>
                </div>
            ...
            <div class="card tx-testimonial-box">
              <div class="card-body">
                ...
                <div class="tx-testimonial-box-auth p-relative">
                  ...
                  <div class="tx-testimonial-box-auth-content">
                    <h4 class="tx-testimonial-box-auth-title">
                      <a href="<?php echo e(route('second', ['pages', 'team'])); ?>">Jennie Kim</a>
                    </h4>
                    <span>USA</span>
                  </div>
                </div>
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\certifico\resources\views/index.blade.php ENDPATH**/ ?>