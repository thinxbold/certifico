  ...
  <section class="tx-section tx-hero-single pb-0">
    <div class="container p-relative h-100">
      ...
      <div class="tx-hero-single-cta">
        <a href="<?php echo e(route('second', ['course', 'single'])); ?>" class="btn btn-secondary btn-icon-leading arrow-right me-2">
          Get Started</i>
        </a>
          ...
          <div class="tx-service-details row justify-content-center g-5 g-xl-7">
                    ...
                    <div class="tx-team-single-content mt-auto pe-0">
                      <div class="d-block">
                        <h4 class="tx-team-single-title">
                          <a href="<?php echo e(route('second', ['pages', 'team'])); ?>">Sorchan Simbolon</a>
                        </h4>
            ...
            <div class="col-12 tx-block-content pt-xl-5 animated">
              ...
              <div class="text-center">
                <hr class="my-5">
                <a href="<?php echo e(route('second', ['course', 'single'])); ?>"
...
<?php echo $__env->make('layouts.landing', ['title' => 'Certifico || CRP - Certified Risk Professional'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\certifico\resources\views/course/introduction.blade.php ENDPATH**/ ?>