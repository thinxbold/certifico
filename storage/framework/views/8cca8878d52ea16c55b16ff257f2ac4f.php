    ...
    <div class="container">
      ...
      <div class="row tx-scroll-md-x g-2 g-md-4 mb-6">
        ...
        <div class="col-8 col-lg-4 col-xl-3 animated">
          <a href="<?php echo e(route('second', ['course', 'introduction'])); ?>" class="tx-gallery-course">
...
<?php echo $__env->make('layouts.landing', ['title' => 'Certifico || Courses'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\certifico\resources\views/course/courses.blade.php ENDPATH**/ ?>