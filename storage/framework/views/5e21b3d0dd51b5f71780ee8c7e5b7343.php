  ...
  <section class="tx-section tx-hero-single pb-0">
    <div class="container p-relative h-100">
      <div class="tx-hero-single-img ratio ratio-1x1 ratio-md-16x9 ratio-xl-21x9">
        <img src="/img/service/CGRCS.avif" alt="" class="img-cover z-n1">
      </div>
      ...
      <div class="row justify-content-center tx-hero-single-caption">
        <div class="col-11 d-flex flex-column" data-bs-theme="dark">
          ...
          <div class="tx-breadcrumb">
            ...
            <h1>CGRCS<sup>&reg;</sup><span>Certified Governance Risk Compliance Specialist</span></h1>
          </div>
        </div>
      </div>
    </div>
              ...
              <div class="col-10">
                <div class="btn-list-group">
                  ...
                  <a href="<?php echo e(route('third', ['services', 'sertifikasi-internasional', 'cgrcs-certified-governance-risk-compliance-specialist'])); ?>"
                    class="btn btn-icon-leading arrow-right d-none">CGRCS<sup>&reg;</sup> Certified Governance Risk
                    Compliance
                    Specialist</a>
                  <a href="<?php echo e(route('third', ['services', 'sertifikasi-internasional', 'cbcmp-certified-business-continuity-management-professional'])); ?>"
                    class="btn btn-icon-leading arrow-right">CBCMP<sup>&reg;</sup> Certified Business Continuity
                    Management
                    Professional</a>
...
<?php echo $__env->make('layouts.landing', ['title' => 'Certifico || Certified Risk Associate'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\certifico\resources\views/services/sertifikasi-internasional/cgrcs-certified-governance-risk-compliance-specialist.blade.php ENDPATH**/ ?>