  ...
  <section class="tx-section tx-hero-single pb-0">
    <div class="container p-relative h-100">
      <div class="tx-hero-single-img ratio ratio-1x1 ratio-md-16x9 ratio-xl-21x9">
        <img src="/img/service/iso-9001.avif" alt="" class="img-cover z-n1">
      </div>
      ...
      <div class="row justify-content-center tx-hero-single-caption">
        <div class="col-11 d-flex flex-column" data-bs-theme="dark">
          <div class="tx-logo-brand">
            <img src="/img/brand/logo-ISO-9001.svg" alt="">
          </div>
              ...
              <div class="col-10">
                <div class="btn-list-group">
                  <a href="<?php echo e(route('third', ['services', 'sertifikasi-iso', 'iso-9001-2015'])); ?>"
                    class="btn btn-icon-leading arrow-right d-none">ISO 9001:2015</a>
...
<?php echo $__env->make('layouts.landing', ['title' => 'Certifico || Certified Risk Associate'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\certifico\resources\views/services/sertifikasi-iso/iso-9001-2015.blade.php ENDPATH**/ ?>